                            ...
                            <ul className="flex flex-col gap-y-[16px] w-full">
                                {item?.list?.map((item,index)=>(
                                    <li key={`list `+index} className="flex items-center gap-x-[16px]">
                                        ...
                                        {item?.link && item.link !== '#' ? (
                                          <a href={item?.link} target="_blank" className='group flex justify-between items-center gap-x-[16px] w-full ss:w-[80%] font-line text-[16px] lg:text-[18px] text-[#0A2B40] font-[400]'>
                                            {item?.name}
