...
export default function CardMoreNews({item,index,locale}) {
  return (
    <div className="flex flex-col w-full md:w-[32%] h-full gap-y-[24px] relative">
        {/* Image */}
        <div className="flex justify-center items-center w-full md:h-[178px] lg:h-[242px] xl:h-[296px]">
