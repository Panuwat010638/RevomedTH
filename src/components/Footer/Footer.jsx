    ...
    <footer className='bg-[#002E62]'>
        <div className="max-w-7xl mx-auto px-6 xl:px-4 pb-[40px] pt-[40px] lg:pt-[64px]">
            <div className="flex flex-col items-center lg:items-start justify-center w-full h-full gap-y-[32px]">
                ...
                {/* Top */}
                <div className="flex flex-col lg:flex-row items-center lg:items-start w-full gap-x-[5%] gap-y-[24px]">
                    {/* R */}
                    <div className="flex flex-col items-center lg:items-start gap-y-[20px] w-full sm:w-[80%] md:w-[60%] lg:w-[30%] pb-[32px] lg:pb-0  border-b-[1px] lg:border-none border-solid border-[#6F7489]">
                        ...
                        <div className="flex flex-row lg:flex-col xl:flex-row justify-between items-end lg:items-center xl:items-end w-full gap-x-[5%] gap-y-[16px]">
                            ...
                            <div className="flex justify-end lg:justify-start xl:justify-end items-center lg:items-end w-auto lg:w-full xl:w-[auto gap-x-[16px]">
