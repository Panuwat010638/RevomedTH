...
export default function Footer() {
    const footer ={
        ...
        location:"บริษัท รีโว่เมด (ไทยแลนด์) จำกัดเลขที่ 29/11 หมู่ที่ 10\nต.บางบัวทอง อ.บางบัวทองจ.นนทบุรี 11110",
        social:{
            line:"#",
            facebook:"#",
            tel:"061-662-4242",
            ...
            <div className="flex flex-col items-center lg:items-start justify-center w-full h-full gap-y-[32px]">
                ...
                <div className="flex flex-col lg:flex-row items-center lg:items-start w-full gap-x-[5%] gap-y-[32px]">
                    ...
                    <div className="flex flex-col items-center lg:items-start gap-y-[20px] w-full sm:w-[80%] md:w-[60%] lg:w-[30%] pb-[32px] lg:pb-0  border-b-[1px] lg:border-none border-solid border-[#6F7489]">
                        ...
                        <p className="text-[16px] text-[#E0E3EB] font-[400] leading-[180%] text-center lg:text-start xl:whitespace-pre-line">
                            {footer?.location}
                        </p>
                        <div className="flex justify-between items-center w-full gap-x-[5%]">
                            <div className="flex flex-col w-[65%] gap-y-[20px]">
                                {/* Tel */}
                    ...
                    <div className="flex flex-col lg:flex-row w-full sm:w-[80%] md:w-[60%] lg:w-[65%] gap-x-[5%] gap-y-[24px]">
                        <div className="grid grid-cols-2 gap-y-[16px] gap-x-[24px] w-full lg:w-[35%] lg:place-items-end">
