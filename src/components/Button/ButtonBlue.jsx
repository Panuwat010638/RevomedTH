...
export default function ButtonBlue({text,link,locale}) {
  return (
    <div className="flex justify-center items-center w-full ss:w-auto">
        <Link href={`/${locale}${link}`} className="flex justify-center items-center w-full ss:w-[294px] px-0 ss:px-[32px] py-[12px] 
